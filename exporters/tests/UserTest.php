...
final class UserTest extends TestCase
{
    ...
    public function testGetImportId(): void
    {
        ...
        $value = $export->getUserImportID( __FUNCTION__ );
    ...
    public function testInsertUser(): void
    {
        ...
        $importId = $export->getUserImportID( __FUNCTION__ );

        {
            $exists = $export->isUserExists( $importId, __FUNCTION__ );
        ...
        {
            $companyId = $export->addUser( $importId, [
        ...
        $this->assertTrue( $export->removeUserByImportID( $importId ), "Can not remove company" );
